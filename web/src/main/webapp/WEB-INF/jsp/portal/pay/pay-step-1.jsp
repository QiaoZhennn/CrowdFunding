                                ...
                                <div class="col-md-12 column">
                                    <table class="table table-bordered" style="text-align:center;">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" style="width:60px;" value="1"></td>
                                    ...
                                    <div style="float:right;">
                                        ...
                                        <button type="button" class="btn btn-warning btn-lg" style="float:right;" onclick="window.location.href='${APP_PATH}/pay/pay-step-2.htm'"><i class="glyphicon glyphicon-credit-card"></i> 去结算</button>
                                    </div>
                                </div>
