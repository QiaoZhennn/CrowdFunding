...
<div class="container theme-showcase" role="main">
    ...
    <form role="form" style="margin-top:20px;">
        <div class="form-group">
            <label for="fcode">验证码</label>
            <input type="text" class="form-control" id="fcode" name="fcode" placeholder="请输入你邮箱中接收到的验证码">
        </div>
    ...
    $("#nextBtn").click(function () {
        $.ajax({
            ...
            success:function (result) {
                if(result){
                    layer.msg("实名认证申请结束，请等待审核",{time:1000});
                    window.location.href="${APP_PATH}/member.htm";
                }else {
                    layer.msg("验证码验证失败",{time:1000});
