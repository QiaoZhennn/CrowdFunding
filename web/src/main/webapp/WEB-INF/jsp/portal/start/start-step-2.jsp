            ...
            <div class="col-md-12 column">
                <div class="panel panel-default" >
                    ...
                    <div class="panel-footer" style="text-align:center;">
                        <button type="button" class="btn  btn-default btn-lg" onclick="window.location.href='${APP_PATH}/start/start-step-1.htm'">上一步</button>
                        <button type="button" class="btn  btn-warning btn-lg" onclick="window.location.href='${APP_PATH}/start/start-step-3.htm'">下一步</button>
                        <a class="btn" > 预览 </a>
                    </div>
                </div>
            </div>
