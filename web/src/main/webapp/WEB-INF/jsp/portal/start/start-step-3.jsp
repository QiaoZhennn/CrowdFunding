            ...
            <div class="col-md-12 column">
                <div class="panel panel-default" >
                    ...
                    <div class="panel-footer" style="text-align:center;">
                        <button type="button" class="btn  btn-default btn-lg" onclick="window.location.href='${APP_PATH}/start/start-step-2.htm'">上一步</button>
                        <button type="button" class="btn  btn-warning btn-lg" onclick="window.location.href='${APP_PATH}/start/start-step-4.htm'">提交</button>
                        <a class="btn" > 保存草稿 </a>
                    </div>
                </div>
            </div>
