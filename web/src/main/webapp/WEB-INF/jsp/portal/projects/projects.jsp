                ...
                <nav class="navbar navbar-default" role="navigation">
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a rel="nofollow" href="${APP_PATH}/start/index.htm"><i class="glyphicon glyphicon-edit"></i> 发起众筹</a>
                            </li>
                            <li>
...
<script>
    ...
    $.each($("a[href='project.html']"),function () {
        $(this).attr("href","${APP_PATH}/project/index.htm");
    });
