                ...
                <nav class="navbar navbar-default" role="navigation">
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active">
                                <a rel="nofollow" href="${APP_PATH}/start/index.htm"><i class="glyphicon glyphicon-edit"></i> 发起项目</a>
                            </li>
                            <li>
                    ...
                    <div class="col-md-4 column">
                        ...
                        <div class="panel panel-default" style="border-radius: 0px;">
                            ...
                            <div class="panel-body">
                                ...
                                <button type="button" class="btn  btn-warning btn-lg" onclick="window.location.href='${APP_PATH}/pay/pay-step-1.htm'">支持</button>
                                <br><br>
